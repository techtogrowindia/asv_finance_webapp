          ...
          <div className="panel-body">
            <div className="table-wrap" style={{ boxShadow: 'none', border: 'none' }}>
              <table className="data">
                <thead><tr><th>Client ID</th><th>Branch</th><th>Center</th><th>Member</th><th>Loan A/c</th><th>Savings A/c</th><th>Start Date</th><th>No. of Dues</th><th>Closed Date</th><th>Status</th><th></th></tr></thead>
                <tbody>
                  {accounts?.map((a) => (
                    <tr key={a.loanId}>
                  ...
                  {accounts && accounts.length === 0 && <tr><td colSpan={11} className="empty">No loans in this center.</td></tr>}
                </tbody>
              </table>
            </div>
          </div>
